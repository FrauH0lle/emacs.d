...
- `minibuffer': Behaves like `both` in the minibuffer and `t`
  otherwise.")
...
If any return non-nil, `corfu-auto' will not invoke as-you-type
completion.")
...
;;; Packages
(use-package! corfu
  :hook (zenit-first-input . global-corfu-mode)
  :config
  (setq corfu-auto t
...
(use-package! corfu-auto
  :defer t
  :config
  (setq corfu-auto-delay (if (featurep :system 'macos) 0.4 0.24)
        corfu-auto-prefix 2)
