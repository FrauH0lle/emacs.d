...
(defun +default/browse-project ()
  ...
  (interactive) (zenit-project-browse (zenit-project-root)))
...
(defun +default/browse-templates ()
  ...
  (interactive) (zenit-project-browse +file-templates-dir))
;;;###autoload
(defun +default/find-in-templates ()
  "Find a file under `+file-templates-dir', recursively."
  (interactive) (zenit-project-find-file +file-templates-dir))
...
(defun +default/browse-notes ()
  ...
  (unless (bound-and-true-p org-directory)
    (require 'org))
  (zenit-project-browse org-directory))
;;;###autoload
(defun +default/find-in-notes ()
  ...
  (unless (bound-and-true-p org-directory)
    (require 'org))
  (zenit-project-find-file org-directory))

;;;###autoload
(defun +default/find-file-under-here ()
  "Perform a recursive file search from the current directory."
  (interactive)
  (zenit-project-find-file default-directory))
...
If prefix ARG is non-nil, prompt for the search path."
  ...
  (if arg
    ...
    (if (not projectile-project-search-path)
      ...
      (letf! (defadvice projectile-add-known-project (:around (orig project-root))
               (unless (projectile-ignored-project-p project-root)
                 (funcall orig project-root)
