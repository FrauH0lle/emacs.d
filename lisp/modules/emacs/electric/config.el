...
(defvar +electric-continue-comments t
...
(use-package! electric
  ...
  (defadvice! +electric--continue-comments-a (fn &rest args)
    ...
    (if (not (and electric-indent-mode
                  ...
                  (zenit-point-in-comment-p (1- (electric--after-char-pos)))
  ...
  ;; Ensure electric-quote's handler runs before smartparens' on
  ;; `post-self-insert-hook', so that `electric-quote-inhibit-functions' (e.g.
  ;; `org-in-src-block-p') is respected in org src blocks.
