...
(defvar +markdown-compile-functions
  ...
  "A list of functions for `markdown-open' or `markdown-preview'.

Stops at the first one to return non-nil. Each function takes three
argument. The beginning position of the region to capture, the end
